...
import { ListValue, Value } from "../../../google/protobuf/struct";
import { LogicalExprNode } from "../../expression/v1/expression";
import { ChalkError } from "./chalk_error";
import { ExplainOptions } from "./online_query";
...
export const OfflineQueryRecomputeFeatures: MessageFns<OfflineQueryRecomputeFeatures> = {
  ...
  create<I extends Exact<DeepPartial<OfflineQueryRecomputeFeatures>, I>>(base?: I): OfflineQueryRecomputeFeatures {
    return OfflineQueryRecomputeFeatures.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<OfflineQueryRecomputeFeatures>, I>>(
    object: I,
  ): OfflineQueryRecomputeFeatures {
    const message = createBaseOfflineQueryRecomputeFeatures();
    message.allOrNone = object.allOrNone ?? undefined;
    message.featureList = (object.featureList !== undefined && object.featureList !== null)
      ? OfflineQueryRecomputeFeatures_FeatureList.fromPartial(object.featureList)
      : undefined;
    return message;
  },
};
...
export const OfflineQueryRecomputeFeatures_FeatureList: MessageFns<OfflineQueryRecomputeFeatures_FeatureList> = {
  ...
  create<I extends Exact<DeepPartial<OfflineQueryRecomputeFeatures_FeatureList>, I>>(
    base?: I,
  ): OfflineQueryRecomputeFeatures_FeatureList {
    return OfflineQueryRecomputeFeatures_FeatureList.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<OfflineQueryRecomputeFeatures_FeatureList>, I>>(
    object: I,
  ): OfflineQueryRecomputeFeatures_FeatureList {
    const message = createBaseOfflineQueryRecomputeFeatures_FeatureList();
    message.featureList = object.featureList?.map((e) => e) || [];
    return message;
  },
};
...
export const OfflineQueryExplain: MessageFns<OfflineQueryExplain> = {
  ...
  create<I extends Exact<DeepPartial<OfflineQueryExplain>, I>>(base?: I): OfflineQueryExplain {
    return OfflineQueryExplain.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<OfflineQueryExplain>, I>>(object: I): OfflineQueryExplain {
    const message = createBaseOfflineQueryExplain();
    message.truthy = object.truthy ?? undefined;
    message.only = (object.only !== undefined && object.only !== null)
      ? OfflineQueryExplain_Only.fromPartial(object.only)
      : undefined;
    return message;
  },
};
...
export const OfflineQueryExplain_Only: MessageFns<OfflineQueryExplain_Only> = {
  ...
  create<I extends Exact<DeepPartial<OfflineQueryExplain_Only>, I>>(base?: I): OfflineQueryExplain_Only {
    return OfflineQueryExplain_Only.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<OfflineQueryExplain_Only>, I>>(_: I): OfflineQueryExplain_Only {
    const message = createBaseOfflineQueryExplain_Only();
    return message;
  },
};
...
export const OfflineQueryInput: MessageFns<OfflineQueryInput> = {
  ...
  create<I extends Exact<DeepPartial<OfflineQueryInput>, I>>(base?: I): OfflineQueryInput {
    return OfflineQueryInput.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<OfflineQueryInput>, I>>(object: I): OfflineQueryInput {
    const message = createBaseOfflineQueryInput();
...
export const OfflineQueryInputSharded: MessageFns<OfflineQueryInputSharded> = {
  ...
  create<I extends Exact<DeepPartial<OfflineQueryInputSharded>, I>>(base?: I): OfflineQueryInputSharded {
    return OfflineQueryInputSharded.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<OfflineQueryInputSharded>, I>>(object: I): OfflineQueryInputSharded {
    const message = createBaseOfflineQueryInputSharded();
    message.inputs = object.inputs?.map((e) => OfflineQueryInput.fromPartial(e)) || [];
    return message;
  },
};
...
export const OfflineQueryInputs: MessageFns<OfflineQueryInputs> = {
  ...
  create<I extends Exact<DeepPartial<OfflineQueryInputs>, I>>(base?: I): OfflineQueryInputs {
    return OfflineQueryInputs.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<OfflineQueryInputs>, I>>(object: I): OfflineQueryInputs {
    const message = createBaseOfflineQueryInputs();
    message.featherInputs = object.featherInputs ?? undefined;
    message.noInputs = (object.noInputs !== undefined && object.noInputs !== null)
      ? OfflineQueryInputs_NoInputs.fromPartial(object.noInputs)
      : undefined;
    message.singleInputs = (object.singleInputs !== undefined && object.singleInputs !== null)
      ? OfflineQueryInput.fromPartial(object.singleInputs)
      : undefined;
    message.shardedInputs = (object.shardedInputs !== undefined && object.shardedInputs !== null)
      ? OfflineQueryInputSharded.fromPartial(object.shardedInputs)
      : undefined;
    return message;
  },
};
...
export const OfflineQueryInputs_NoInputs: MessageFns<OfflineQueryInputs_NoInputs> = {
  ...
  create<I extends Exact<DeepPartial<OfflineQueryInputs_NoInputs>, I>>(base?: I): OfflineQueryInputs_NoInputs {
    return OfflineQueryInputs_NoInputs.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<OfflineQueryInputs_NoInputs>, I>>(_: I): OfflineQueryInputs_NoInputs {
    const message = createBaseOfflineQueryInputs_NoInputs();
    return message;
  },
};
...
export const OfflineQueryRequest: MessageFns<OfflineQueryRequest> = {
  ...
  create<I extends Exact<DeepPartial<OfflineQueryRequest>, I>>(base?: I): OfflineQueryRequest {
    return OfflineQueryRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<OfflineQueryRequest>, I>>(object: I): OfflineQueryRequest {
    const message = createBaseOfflineQueryRequest();
    message.inputs = (object.inputs !== undefined && object.inputs !== null)
      ? OfflineQueryInputs.fromPartial(object.inputs)
      : undefined;
    message.outputs = object.outputs?.map((e) => e) || [];
    message.requiredOutputs = object.requiredOutputs?.map((e) => e) || [];
    ...
    message.recomputeFeatures = (object.recomputeFeatures !== undefined && object.recomputeFeatures !== null)
      ? OfflineQueryRecomputeFeatures.fromPartial(object.recomputeFeatures)
      : undefined;
    message.storePlanStages = object.storePlanStages ?? false;
    ...
    message.explain = (object.explain !== undefined && object.explain !== null)
      ? OfflineQueryExplain.fromPartial(object.explain)
      : undefined;
    message.explain2 = (object.explain2 !== undefined && object.explain2 !== null)
      ? ExplainOptions.fromPartial(object.explain2)
      : undefined;
    ...
    message.observedAtLowerBound = object.observedAtLowerBound ?? undefined;
    message.observedAtUpperBound = object.observedAtUpperBound ?? undefined;
    message.plannerOptions = Object.entries(object.plannerOptions ?? {}).reduce<{ [key: string]: any | undefined }>(
      (acc, [key, value]) => {
        if (value !== undefined) {
          acc[key] = value;
        }
    ...
    message.useMultipleComputers = object.useMultipleComputers ?? undefined;
    message.numShards = object.numShards ?? undefined;
    message.numWorkers = object.numWorkers ?? undefined;
...
export const OfflineQueryRequest_PlannerOptionsEntry: MessageFns<OfflineQueryRequest_PlannerOptionsEntry> = {
  ...
  create<I extends Exact<DeepPartial<OfflineQueryRequest_PlannerOptionsEntry>, I>>(
    base?: I,
  ): OfflineQueryRequest_PlannerOptionsEntry {
    return OfflineQueryRequest_PlannerOptionsEntry.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<OfflineQueryRequest_PlannerOptionsEntry>, I>>(
    object: I,
  ): OfflineQueryRequest_PlannerOptionsEntry {
    const message = createBaseOfflineQueryRequest_PlannerOptionsEntry();
...
export const OfflineQueryRequest_QueryContextEntry: MessageFns<OfflineQueryRequest_QueryContextEntry> = {
  ...
  create<I extends Exact<DeepPartial<OfflineQueryRequest_QueryContextEntry>, I>>(
    base?: I,
  ): OfflineQueryRequest_QueryContextEntry {
    return OfflineQueryRequest_QueryContextEntry.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<OfflineQueryRequest_QueryContextEntry>, I>>(
    object: I,
  ): OfflineQueryRequest_QueryContextEntry {
    const message = createBaseOfflineQueryRequest_QueryContextEntry();
    message.key = object.key ?? "";
...
export const ColumnMetadataList: MessageFns<ColumnMetadataList> = {
  ...
  create<I extends Exact<DeepPartial<ColumnMetadataList>, I>>(base?: I): ColumnMetadataList {
    return ColumnMetadataList.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ColumnMetadataList>, I>>(object: I): ColumnMetadataList {
    const message = createBaseColumnMetadataList();
    message.metadata = object.metadata?.map((e) => ColumnMetadataList_ColumnMetadata.fromPartial(e)) || [];
    return message;
  },
};
...
export const ColumnMetadataList_ColumnMetadata: MessageFns<ColumnMetadataList_ColumnMetadata> = {
  ...
  create<I extends Exact<DeepPartial<ColumnMetadataList_ColumnMetadata>, I>>(
    base?: I,
  ): ColumnMetadataList_ColumnMetadata {
    return ColumnMetadataList_ColumnMetadata.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ColumnMetadataList_ColumnMetadata>, I>>(
    object: I,
  ): ColumnMetadataList_ColumnMetadata {
    const message = createBaseColumnMetadataList_ColumnMetadata();
...
export const GetOfflineQueryJobResponse: MessageFns<GetOfflineQueryJobResponse> = {
  ...
  create<I extends Exact<DeepPartial<GetOfflineQueryJobResponse>, I>>(base?: I): GetOfflineQueryJobResponse {
    return GetOfflineQueryJobResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<GetOfflineQueryJobResponse>, I>>(object: I): GetOfflineQueryJobResponse {
    const message = createBaseGetOfflineQueryJobResponse();
