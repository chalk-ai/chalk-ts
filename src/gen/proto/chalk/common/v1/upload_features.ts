...
export const UploadFeaturesRequest: MessageFns<UploadFeaturesRequest> = {
  ...
  create<I extends Exact<DeepPartial<UploadFeaturesRequest>, I>>(base?: I): UploadFeaturesRequest {
    return UploadFeaturesRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<UploadFeaturesRequest>, I>>(object: I): UploadFeaturesRequest {
    const message = createBaseUploadFeaturesRequest();
    message.inputsTable = object.inputsTable ?? new Uint8Array(0);
    return message;
  },
};
...
export const UploadFeaturesResponse: MessageFns<UploadFeaturesResponse> = {
  ...
  create<I extends Exact<DeepPartial<UploadFeaturesResponse>, I>>(base?: I): UploadFeaturesResponse {
    return UploadFeaturesResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<UploadFeaturesResponse>, I>>(object: I): UploadFeaturesResponse {
    const message = createBaseUploadFeaturesResponse();
