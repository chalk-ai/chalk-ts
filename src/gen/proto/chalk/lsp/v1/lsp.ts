...
export const LSP: MessageFns<LSP> = {
  ...
  create<I extends Exact<DeepPartial<LSP>, I>>(base?: I): LSP {
    return LSP.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<LSP>, I>>(object: I): LSP {
    const message = createBaseLSP();
    message.diagnostics = object.diagnostics?.map((e) => PublishDiagnosticsParams.fromPartial(e)) || [];
    message.actions = object.actions?.map((e) => CodeAction.fromPartial(e)) || [];
    return message;
  },
};
...
export const PublishDiagnosticsParams: MessageFns<PublishDiagnosticsParams> = {
  ...
  create<I extends Exact<DeepPartial<PublishDiagnosticsParams>, I>>(base?: I): PublishDiagnosticsParams {
    return PublishDiagnosticsParams.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<PublishDiagnosticsParams>, I>>(object: I): PublishDiagnosticsParams {
    const message = createBasePublishDiagnosticsParams();
...
export const Diagnostic: MessageFns<Diagnostic> = {
  ...
  fromPartial<I extends Exact<DeepPartial<Diagnostic>, I>>(object: I): Diagnostic {
    ...
    message.codeDescription = (object.codeDescription !== undefined && object.codeDescription !== null)
      ? CodeDescription.fromPartial(object.codeDescription)
      : undefined;
    message.relatedInformation = object.relatedInformation?.map((e) => DiagnosticRelatedInformation.fromPartial(e)) ||
      [];
    return message;
  },
};
...
export const CodeAction: MessageFns<CodeAction> = {
  ...
  create<I extends Exact<DeepPartial<CodeAction>, I>>(base?: I): CodeAction {
    return CodeAction.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CodeAction>, I>>(object: I): CodeAction {
    const message = createBaseCodeAction();
    message.title = object.title ?? "";
    message.diagnostics = object.diagnostics?.map((e) => Diagnostic.fromPartial(e)) || [];
    message.edit = (object.edit !== undefined && object.edit !== null)
      ? WorkspaceEdit.fromPartial(object.edit)
      : undefined;
    return message;
  },
};
...
export const WorkspaceEdit: MessageFns<WorkspaceEdit> = {
  ...
  fromPartial<I extends Exact<DeepPartial<WorkspaceEdit>, I>>(object: I): WorkspaceEdit {
    const message = createBaseWorkspaceEdit();
    message.documentChanges = object.documentChanges?.map((e) => TextDocumentEdit.fromPartial(e)) || [];
    return message;
  },
};
...
export const TextDocumentEdit: MessageFns<TextDocumentEdit> = {
  ...
  create<I extends Exact<DeepPartial<TextDocumentEdit>, I>>(base?: I): TextDocumentEdit {
    return TextDocumentEdit.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<TextDocumentEdit>, I>>(object: I): TextDocumentEdit {
    const message = createBaseTextDocumentEdit();
    message.textDocument = (object.textDocument !== undefined && object.textDocument !== null)
      ? TextDocumentIdentifier.fromPartial(object.textDocument)
      : undefined;
...
export const TextDocumentIdentifier: MessageFns<TextDocumentIdentifier> = {
  ...
  create<I extends Exact<DeepPartial<TextDocumentIdentifier>, I>>(base?: I): TextDocumentIdentifier {
    return TextDocumentIdentifier.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<TextDocumentIdentifier>, I>>(object: I): TextDocumentIdentifier {
    const message = createBaseTextDocumentIdentifier();
    message.uri = object.uri ?? "";
    return message;
  },
...
export const CodeDescription: MessageFns<CodeDescription> = {
  ...
  create<I extends Exact<DeepPartial<CodeDescription>, I>>(base?: I): CodeDescription {
    return CodeDescription.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CodeDescription>, I>>(object: I): CodeDescription {
    const message = createBaseCodeDescription();
...
export const DiagnosticRelatedInformation: MessageFns<DiagnosticRelatedInformation> = {
  ...
  create<I extends Exact<DeepPartial<DiagnosticRelatedInformation>, I>>(base?: I): DiagnosticRelatedInformation {
    return DiagnosticRelatedInformation.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<DiagnosticRelatedInformation>, I>>(object: I): DiagnosticRelatedInformation {
    const message = createBaseDiagnosticRelatedInformation();
