...
export const FeaturePermissions: MessageFns<FeaturePermissions> = {
  ...
  create<I extends Exact<DeepPartial<FeaturePermissions>, I>>(base?: I): FeaturePermissions {
    return FeaturePermissions.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<FeaturePermissions>, I>>(object: I): FeaturePermissions {
    const message = createBaseFeaturePermissions();
    message.tags = Object.entries(object.tags ?? {}).reduce<{ [key: string]: FeaturePermission }>(
      (acc, [key, value]) => {
        if (value !== undefined) {
...
export const FeaturePermissions_TagsEntry: MessageFns<FeaturePermissions_TagsEntry> = {
  ...
  create<I extends Exact<DeepPartial<FeaturePermissions_TagsEntry>, I>>(base?: I): FeaturePermissions_TagsEntry {
    return FeaturePermissions_TagsEntry.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<FeaturePermissions_TagsEntry>, I>>(object: I): FeaturePermissions_TagsEntry {
    const message = createBaseFeaturePermissions_TagsEntry();
