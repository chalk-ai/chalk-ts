...
export const AlertTrigger: MessageFns<AlertTrigger> = {
  ...
  create<I extends Exact<DeepPartial<AlertTrigger>, I>>(base?: I): AlertTrigger {
    return AlertTrigger.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<AlertTrigger>, I>>(object: I): AlertTrigger {
    const message = createBaseAlertTrigger();
    message.name = object.name ?? "";
    message.severity = object.severity ?? 0;
    message.thresholdPosition = object.thresholdPosition ?? 0;
...
export const DatasetFeatureOperand: MessageFns<DatasetFeatureOperand> = {
  ...
  create<I extends Exact<DeepPartial<DatasetFeatureOperand>, I>>(base?: I): DatasetFeatureOperand {
    return DatasetFeatureOperand.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<DatasetFeatureOperand>, I>>(object: I): DatasetFeatureOperand {
    const message = createBaseDatasetFeatureOperand();
...
export const MetricFormula: MessageFns<MetricFormula> = {
  ...
  create<I extends Exact<DeepPartial<MetricFormula>, I>>(base?: I): MetricFormula {
    return MetricFormula.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MetricFormula>, I>>(object: I): MetricFormula {
    const message = createBaseMetricFormula();
    message.kind = object.kind ?? 0;
    message.singleSeriesOperands = object.singleSeriesOperands ?? undefined;
    message.multiSeriesOperands = object.multiSeriesOperands?.map((e) => e) || [];
    message.datasetFeatureOperands =
      (object.datasetFeatureOperands !== undefined && object.datasetFeatureOperands !== null)
        ? DatasetFeatureOperand.fromPartial(object.datasetFeatureOperands)
        : undefined;
...
export const MetricConfigSeries: MessageFns<MetricConfigSeries> = {
  ...
  create<I extends Exact<DeepPartial<MetricConfigSeries>, I>>(base?: I): MetricConfigSeries {
    return MetricConfigSeries.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MetricConfigSeries>, I>>(object: I): MetricConfigSeries {
    const message = createBaseMetricConfigSeries();
    message.metric = object.metric ?? 0;
    message.filters = object.filters?.map((e) => MetricFilter.fromPartial(e)) || [];
    message.name = object.name ?? undefined;
    message.windowFunction = object.windowFunction ?? 0;
...
export const MetricConfig: MessageFns<MetricConfig> = {
  ...
  fromPartial<I extends Exact<DeepPartial<MetricConfig>, I>>(object: I): MetricConfig {
    const message = createBaseMetricConfig();
    message.name = object.name ?? "";
    message.windowPeriod = object.windowPeriod ?? "";
    message.series = object.series?.map((e) => MetricConfigSeries.fromPartial(e)) || [];
    message.formulas = object.formulas?.map((e) => MetricFormula.fromPartial(e)) || [];
    message.trigger = (object.trigger !== undefined && object.trigger !== null)
      ? AlertTrigger.fromPartial(object.trigger)
      : undefined;
    return message;
  },
};
...
export const Chart: MessageFns<Chart> = {
  ...
  fromPartial<I extends Exact<DeepPartial<Chart>, I>>(object: I): Chart {
    ...
    message.config = (object.config !== undefined && object.config !== null)
      ? MetricConfig.fromPartial(object.config)
      : undefined;
