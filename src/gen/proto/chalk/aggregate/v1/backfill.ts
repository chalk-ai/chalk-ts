...
export const AggregateBackfillCostEstimate: MessageFns<AggregateBackfillCostEstimate> = {
  ...
  create<I extends Exact<DeepPartial<AggregateBackfillCostEstimate>, I>>(base?: I): AggregateBackfillCostEstimate {
    return AggregateBackfillCostEstimate.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<AggregateBackfillCostEstimate>, I>>(
    object: I,
  ): AggregateBackfillCostEstimate {
    const message = createBaseAggregateBackfillCostEstimate();
    message.maxBuckets = object.maxBuckets ?? 0;
    message.expectedBuckets = object.expectedBuckets ?? 0;
    message.expectedBytes = object.expectedBytes ?? 0;
    message.expectedStorageCost = object.expectedStorageCost ?? 0;
    message.expectedRuntime = (object.expectedRuntime !== undefined && object.expectedRuntime !== null)
      ? Duration.fromPartial(object.expectedRuntime)
      : undefined;
    return message;
  },
};
...
export const AggregateBackfillUserParams: MessageFns<AggregateBackfillUserParams> = {
  ...
  create<I extends Exact<DeepPartial<AggregateBackfillUserParams>, I>>(base?: I): AggregateBackfillUserParams {
    return AggregateBackfillUserParams.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<AggregateBackfillUserParams>, I>>(object: I): AggregateBackfillUserParams {
    const message = createBaseAggregateBackfillUserParams();
    message.features = object.features?.map((e) => e) || [];
    message.resolver = object.resolver ?? undefined;
    message.timestampColumnName = object.timestampColumnName ?? undefined;
...
export const AggregateBackfill: MessageFns<AggregateBackfill> = {
  ...
  create<I extends Exact<DeepPartial<AggregateBackfill>, I>>(base?: I): AggregateBackfill {
    return AggregateBackfill.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<AggregateBackfill>, I>>(object: I): AggregateBackfill {
    const message = createBaseAggregateBackfill();
    ...
    message.maxRetention = (object.maxRetention !== undefined && object.maxRetention !== null)
      ? Duration.fromPartial(object.maxRetention)
      : undefined;
    message.lowerBound = object.lowerBound ?? undefined;
    message.upperBound = object.upperBound ?? undefined;
    return message;
...
export const AggregateBackfillWithCostEstimate: MessageFns<AggregateBackfillWithCostEstimate> = {
  ...
  create<I extends Exact<DeepPartial<AggregateBackfillWithCostEstimate>, I>>(
    base?: I,
  ): AggregateBackfillWithCostEstimate {
    return AggregateBackfillWithCostEstimate.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<AggregateBackfillWithCostEstimate>, I>>(
    object: I,
  ): AggregateBackfillWithCostEstimate {
    const message = createBaseAggregateBackfillWithCostEstimate();
    message.backfill = (object.backfill !== undefined && object.backfill !== null)
      ? AggregateBackfill.fromPartial(object.backfill)
      : undefined;
...
export const AggregateBackfillJob: MessageFns<AggregateBackfillJob> = {
  ...
  create<I extends Exact<DeepPartial<AggregateBackfillJob>, I>>(base?: I): AggregateBackfillJob {
    return AggregateBackfillJob.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<AggregateBackfillJob>, I>>(object: I): AggregateBackfillJob {
    const message = createBaseAggregateBackfillJob();
    ...
    message.cronAggregateBackfillId = object.cronAggregateBackfillId ?? undefined;
...
export const CronAggregateBackfill: MessageFns<CronAggregateBackfill> = {
  ...
  create<I extends Exact<DeepPartial<CronAggregateBackfill>, I>>(base?: I): CronAggregateBackfill {
    return CronAggregateBackfill.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CronAggregateBackfill>, I>>(object: I): CronAggregateBackfill {
    const message = createBaseCronAggregateBackfill();
    message.id = object.id ?? "";
    message.environmentId = object.environmentId ?? "";
