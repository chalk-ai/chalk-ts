...
export const GetQueryPerformanceSummaryRequest: MessageFns<GetQueryPerformanceSummaryRequest> = {
  ...
  create<I extends Exact<DeepPartial<GetQueryPerformanceSummaryRequest>, I>>(
    base?: I,
  ): GetQueryPerformanceSummaryRequest {
    return GetQueryPerformanceSummaryRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<GetQueryPerformanceSummaryRequest>, I>>(
    object: I,
  ): GetQueryPerformanceSummaryRequest {
    const message = createBaseGetQueryPerformanceSummaryRequest();
...
export const GetQueryPerformanceSummaryResponse: MessageFns<GetQueryPerformanceSummaryResponse> = {
  ...
  create<I extends Exact<DeepPartial<GetQueryPerformanceSummaryResponse>, I>>(
    base?: I,
  ): GetQueryPerformanceSummaryResponse {
    return GetQueryPerformanceSummaryResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<GetQueryPerformanceSummaryResponse>, I>>(
    object: I,
  ): GetQueryPerformanceSummaryResponse {
    const message = createBaseGetQueryPerformanceSummaryResponse();
    message.operationId = object.operationId ?? "";
    message.performanceSummary = object.performanceSummary ?? undefined;
    return message;
  },
};
...
export const ListQueryErrorsPageToken: MessageFns<ListQueryErrorsPageToken> = {
  ...
  create<I extends Exact<DeepPartial<ListQueryErrorsPageToken>, I>>(base?: I): ListQueryErrorsPageToken {
    return ListQueryErrorsPageToken.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ListQueryErrorsPageToken>, I>>(object: I): ListQueryErrorsPageToken {
    const message = createBaseListQueryErrorsPageToken();
    message.numericIdHwm = object.numericIdHwm ?? 0;
    message.errorTimestampHwm = object.errorTimestampHwm ?? undefined;
    return message;
  },
};
...
export const QueryErrorFilters: MessageFns<QueryErrorFilters> = {
  ...
  create<I extends Exact<DeepPartial<QueryErrorFilters>, I>>(base?: I): QueryErrorFilters {
    return QueryErrorFilters.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QueryErrorFilters>, I>>(object: I): QueryErrorFilters {
    const message = createBaseQueryErrorFilters();
    message.operationId = object.operationId ?? undefined;
    message.featureFqn = object.featureFqn ?? undefined;
    message.resolverFqn = object.resolverFqn ?? undefined;
...
export const QueryErrorMeta: MessageFns<QueryErrorMeta> = {
  ...
  create<I extends Exact<DeepPartial<QueryErrorMeta>, I>>(base?: I): QueryErrorMeta {
    return QueryErrorMeta.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QueryErrorMeta>, I>>(object: I): QueryErrorMeta {
    const message = createBaseQueryErrorMeta();
    ...
    message.queryName = object.queryName ?? undefined;
    message.exceptionKind = object.exceptionKind ?? undefined;
    message.exceptionMessage = object.exceptionMessage ?? undefined;
    message.exceptionStacktrace = object.exceptionStacktrace ?? undefined;
    message.exceptionInternalStacktrace = object.exceptionInternalStacktrace ?? undefined;
    message.operationId = object.operationId ?? undefined;
...
export const ListQueryErrorsRequest: MessageFns<ListQueryErrorsRequest> = {
  ...
  create<I extends Exact<DeepPartial<ListQueryErrorsRequest>, I>>(base?: I): ListQueryErrorsRequest {
    return ListQueryErrorsRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ListQueryErrorsRequest>, I>>(object: I): ListQueryErrorsRequest {
    const message = createBaseListQueryErrorsRequest();
    message.startDate = object.startDate ?? undefined;
    message.endDate = object.endDate ?? undefined;
    message.filters = (object.filters !== undefined && object.filters !== null)
      ? QueryErrorFilters.fromPartial(object.filters)
      : undefined;
...
export const ListQueryErrorsResponse: MessageFns<ListQueryErrorsResponse> = {
  ...
  create<I extends Exact<DeepPartial<ListQueryErrorsResponse>, I>>(base?: I): ListQueryErrorsResponse {
    return ListQueryErrorsResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ListQueryErrorsResponse>, I>>(object: I): ListQueryErrorsResponse {
    const message = createBaseListQueryErrorsResponse();
    message.queryErrors = object.queryErrors?.map((e) => QueryErrorMeta.fromPartial(e)) || [];
...
export const GetQueryErrorsChartRequest: MessageFns<GetQueryErrorsChartRequest> = {
  ...
  create<I extends Exact<DeepPartial<GetQueryErrorsChartRequest>, I>>(base?: I): GetQueryErrorsChartRequest {
    return GetQueryErrorsChartRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<GetQueryErrorsChartRequest>, I>>(object: I): GetQueryErrorsChartRequest {
    const message = createBaseGetQueryErrorsChartRequest();
...
export const GetQueryErrorsChartResponse: MessageFns<GetQueryErrorsChartResponse> = {
  ...
  create<I extends Exact<DeepPartial<GetQueryErrorsChartResponse>, I>>(base?: I): GetQueryErrorsChartResponse {
    return GetQueryErrorsChartResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<GetQueryErrorsChartResponse>, I>>(object: I): GetQueryErrorsChartResponse {
    const message = createBaseGetQueryErrorsChartResponse();
