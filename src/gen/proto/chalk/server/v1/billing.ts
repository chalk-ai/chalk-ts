...
import { KubernetesNodeData } from "../../kubernetes/v1/nodes";
import { KubernetesPodData } from "../../kubernetes/v1/pods";
import { NodeStatusPubSub } from "../../pubsub/v1/node_status";
import { PodStatusPubSub } from "../../pubsub/v1/pod_status";
import { MachineRate } from "../../usage/v1/rate";
import { Chart } from "./chart";
import { GetPodRequestChartsRequest, GetPodRequestChartsResponse } from "./pod_request";
...
export const GetUsageChartRequest: MessageFns<GetUsageChartRequest> = {
  ...
  create<I extends Exact<DeepPartial<GetUsageChartRequest>, I>>(base?: I): GetUsageChartRequest {
    return GetUsageChartRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<GetUsageChartRequest>, I>>(object: I): GetUsageChartRequest {
    const message = createBaseGetUsageChartRequest();
...
export const GetUsageChartResponse: MessageFns<GetUsageChartResponse> = {
  ...
  create<I extends Exact<DeepPartial<GetUsageChartResponse>, I>>(base?: I): GetUsageChartResponse {
    return GetUsageChartResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<GetUsageChartResponse>, I>>(object: I): GetUsageChartResponse {
    const message = createBaseGetUsageChartResponse();
...
export const GetUtilizationRatesRequest: MessageFns<GetUtilizationRatesRequest> = {
  ...
  create<I extends Exact<DeepPartial<GetUtilizationRatesRequest>, I>>(base?: I): GetUtilizationRatesRequest {
    return GetUtilizationRatesRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<GetUtilizationRatesRequest>, I>>(_: I): GetUtilizationRatesRequest {
    const message = createBaseGetUtilizationRatesRequest();
    return message;
  },
};
...
export const GetUtilizationRatesResponse: MessageFns<GetUtilizationRatesResponse> = {
  ...
  create<I extends Exact<DeepPartial<GetUtilizationRatesResponse>, I>>(base?: I): GetUtilizationRatesResponse {
    return GetUtilizationRatesResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<GetUtilizationRatesResponse>, I>>(object: I): GetUtilizationRatesResponse {
    const message = createBaseGetUtilizationRatesResponse();
    message.rates = object.rates?.map((e) => MachineRate.fromPartial(e)) || [];
    return message;
  },
};
...
export const GetNodesAndPodsRequest: MessageFns<GetNodesAndPodsRequest> = {
  ...
  create<I extends Exact<DeepPartial<GetNodesAndPodsRequest>, I>>(base?: I): GetNodesAndPodsRequest {
    return GetNodesAndPodsRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<GetNodesAndPodsRequest>, I>>(object: I): GetNodesAndPodsRequest {
    const message = createBaseGetNodesAndPodsRequest();
    message.namespace = object.namespace ?? undefined;
    message.podLabelSelector = object.podLabelSelector ?? undefined;
...
export const GetNodesAndPodsResponse: MessageFns<GetNodesAndPodsResponse> = {
  ...
  create<I extends Exact<DeepPartial<GetNodesAndPodsResponse>, I>>(base?: I): GetNodesAndPodsResponse {
    return GetNodesAndPodsResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<GetNodesAndPodsResponse>, I>>(object: I): GetNodesAndPodsResponse {
    const message = createBaseGetNodesAndPodsResponse();
    message.nodes = object.nodes?.map((e) => NodeStatusPubSub.fromPartial(e)) || [];
    message.pods = object.pods?.map((e) => PodStatusPubSub.fromPartial(e)) || [];
    return message;
  },
};
...
export const GetNodesAndPodsUIRequest: MessageFns<GetNodesAndPodsUIRequest> = {
  ...
  create<I extends Exact<DeepPartial<GetNodesAndPodsUIRequest>, I>>(base?: I): GetNodesAndPodsUIRequest {
    return GetNodesAndPodsUIRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<GetNodesAndPodsUIRequest>, I>>(object: I): GetNodesAndPodsUIRequest {
    const message = createBaseGetNodesAndPodsUIRequest();
    message.namespace = object.namespace ?? undefined;
    message.podLabelSelector = object.podLabelSelector ?? undefined;
    message.environmentId = object.environmentId ?? undefined;
...
export const GetNodesAndPodsUIResponse: MessageFns<GetNodesAndPodsUIResponse> = {
  ...
  create<I extends Exact<DeepPartial<GetNodesAndPodsUIResponse>, I>>(base?: I): GetNodesAndPodsUIResponse {
    return GetNodesAndPodsUIResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<GetNodesAndPodsUIResponse>, I>>(object: I): GetNodesAndPodsUIResponse {
    const message = createBaseGetNodesAndPodsUIResponse();
    message.nodes = object.nodes?.map((e) => KubernetesNodeData.fromPartial(e)) || [];
    message.pods = object.pods?.map((e) => KubernetesPodData.fromPartial(e)) || [];
    return message;
  },
};
...
export const SyncUtilizationRequest: MessageFns<SyncUtilizationRequest> = {
  ...
  create<I extends Exact<DeepPartial<SyncUtilizationRequest>, I>>(base?: I): SyncUtilizationRequest {
    return SyncUtilizationRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<SyncUtilizationRequest>, I>>(_: I): SyncUtilizationRequest {
    const message = createBaseSyncUtilizationRequest();
    return message;
  },
};
...
export const SyncUtilizationResponse: MessageFns<SyncUtilizationResponse> = {
  ...
  create<I extends Exact<DeepPartial<SyncUtilizationResponse>, I>>(base?: I): SyncUtilizationResponse {
    return SyncUtilizationResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<SyncUtilizationResponse>, I>>(_: I): SyncUtilizationResponse {
    const message = createBaseSyncUtilizationResponse();
    return message;
  },
};
