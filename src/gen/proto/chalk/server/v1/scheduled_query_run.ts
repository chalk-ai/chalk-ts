...
import { OfflineQueryMeta } from "./offline_queries";
...
export const ScheduledQueryRun: MessageFns<ScheduledQueryRun> = {
  ...
  create<I extends Exact<DeepPartial<ScheduledQueryRun>, I>>(base?: I): ScheduledQueryRun {
    return ScheduledQueryRun.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ScheduledQueryRun>, I>>(object: I): ScheduledQueryRun {
    const message = createBaseScheduledQueryRun();
    ...
    message.cronQueryId = object.cronQueryId ?? 0;
    message.cronQueryScheduleId = object.cronQueryScheduleId ?? 0;
    message.cronName = object.cronName ?? "";
    message.gcrExecutionId = object.gcrExecutionId ?? undefined;
    message.gcrJobName = object.gcrJobName ?? undefined;
...
export const GetScheduledQueryRunRequest: MessageFns<GetScheduledQueryRunRequest> = {
  ...
  create<I extends Exact<DeepPartial<GetScheduledQueryRunRequest>, I>>(base?: I): GetScheduledQueryRunRequest {
    return GetScheduledQueryRunRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<GetScheduledQueryRunRequest>, I>>(object: I): GetScheduledQueryRunRequest {
    const message = createBaseGetScheduledQueryRunRequest();
    message.runId = object.runId ?? undefined;
    message.offlineQueryId = object.offlineQueryId ?? undefined;
    message.getMask = object.getMask ?? undefined;
    return message;
  },
};
...
export const GetScheduledQueryRunResponse: MessageFns<GetScheduledQueryRunResponse> = {
  ...
  create<I extends Exact<DeepPartial<GetScheduledQueryRunResponse>, I>>(base?: I): GetScheduledQueryRunResponse {
    return GetScheduledQueryRunResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<GetScheduledQueryRunResponse>, I>>(object: I): GetScheduledQueryRunResponse {
    const message = createBaseGetScheduledQueryRunResponse();
    message.scheduledQueryRun = (object.scheduledQueryRun !== undefined && object.scheduledQueryRun !== null)
      ? ScheduledQueryRun.fromPartial(object.scheduledQueryRun)
      : undefined;
