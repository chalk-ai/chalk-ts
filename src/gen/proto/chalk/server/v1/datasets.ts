...
export const DatasetRevisionMeta: MessageFns<DatasetRevisionMeta> = {
  ...
  create<I extends Exact<DeepPartial<DatasetRevisionMeta>, I>>(base?: I): DatasetRevisionMeta {
    return DatasetRevisionMeta.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<DatasetRevisionMeta>, I>>(object: I): DatasetRevisionMeta {
    const message = createBaseDatasetRevisionMeta();
    ...
    message.givensVersion = object.givensVersion ?? undefined;
    message.outputUri = object.outputUri ?? undefined;
    message.outputVersion = object.outputVersion ?? undefined;
    message.branchName = object.branchName ?? undefined;
    message.numRows = object.numRows ?? undefined;
    message.physicalSizeBytes = object.physicalSizeBytes ?? undefined;
    message.outputColumns = object.outputColumns?.map((e) => e) || [];
    message.outputFqns = object.outputFqns?.map((e) => e) || [];
    message.agentId = object.agentId ?? undefined;
    message.completedAt = object.completedAt ?? undefined;
    message.numShards = object.numShards ?? undefined;
    message.numComputers = object.numComputers ?? undefined;
    message.metadata = object.metadata ?? undefined;
    message.status = object.status ?? undefined;
    message.numRowsCalculated = object.numRowsCalculated ?? undefined;
    message.physicalSizeBytesCalculated = object.physicalSizeBytesCalculated ?? undefined;
...
export const DatasetMeta: MessageFns<DatasetMeta> = {
  ...
  create<I extends Exact<DeepPartial<DatasetMeta>, I>>(base?: I): DatasetMeta {
    return DatasetMeta.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<DatasetMeta>, I>>(object: I): DatasetMeta {
    const message = createBaseDatasetMeta();
    message.id = object.id ?? "";
    message.environmentId = object.environmentId ?? "";
    message.datasetName = object.datasetName ?? undefined;
    message.createdAt = object.createdAt ?? undefined;
    message.mostRecentRevision = (object.mostRecentRevision !== undefined && object.mostRecentRevision !== null)
      ? DatasetRevisionMeta.fromPartial(object.mostRecentRevision)
      : undefined;
    return message;
  },
};
...
export const ListDatasetsResponse: MessageFns<ListDatasetsResponse> = {
  ...
  create<I extends Exact<DeepPartial<ListDatasetsResponse>, I>>(base?: I): ListDatasetsResponse {
    return ListDatasetsResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ListDatasetsResponse>, I>>(object: I): ListDatasetsResponse {
    const message = createBaseListDatasetsResponse();
    message.datasets = object.datasets?.map((e) => DatasetMeta.fromPartial(e)) || [];
    message.cursor = object.cursor ?? undefined;
    return message;
  },
};
...
export const GetDatasetResponse: MessageFns<GetDatasetResponse> = {
  ...
  fromPartial<I extends Exact<DeepPartial<GetDatasetResponse>, I>>(object: I): GetDatasetResponse {
    ...
    message.dataset = (object.dataset !== undefined && object.dataset !== null)
      ? DatasetMeta.fromPartial(object.dataset)
      : undefined;
    return message;
  },
};
...
export const ListDatasetRevisionsRequest: MessageFns<ListDatasetRevisionsRequest> = {
  ...
  create<I extends Exact<DeepPartial<ListDatasetRevisionsRequest>, I>>(base?: I): ListDatasetRevisionsRequest {
    return ListDatasetRevisionsRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ListDatasetRevisionsRequest>, I>>(object: I): ListDatasetRevisionsRequest {
    const message = createBaseListDatasetRevisionsRequest();
    message.datasetId = object.datasetId ?? "";
    message.cursor = object.cursor ?? undefined;
    message.limit = object.limit ?? undefined;
...
export const ListDatasetRevisionsResponse: MessageFns<ListDatasetRevisionsResponse> = {
  ...
  create<I extends Exact<DeepPartial<ListDatasetRevisionsResponse>, I>>(base?: I): ListDatasetRevisionsResponse {
    return ListDatasetRevisionsResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ListDatasetRevisionsResponse>, I>>(object: I): ListDatasetRevisionsResponse {
    const message = createBaseListDatasetRevisionsResponse();
    message.revisions = object.revisions?.map((e) => DatasetRevisionMeta.fromPartial(e)) || [];
    message.cursor = object.cursor ?? undefined;
    return message;
  },
};
...
export const GetDatasetRevisionRequest: MessageFns<GetDatasetRevisionRequest> = {
  ...
  create<I extends Exact<DeepPartial<GetDatasetRevisionRequest>, I>>(base?: I): GetDatasetRevisionRequest {
    return GetDatasetRevisionRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<GetDatasetRevisionRequest>, I>>(object: I): GetDatasetRevisionRequest {
    const message = createBaseGetDatasetRevisionRequest();
    message.id = object.id ?? "";
    return message;
  },
...
export const GetDatasetRevisionResponse: MessageFns<GetDatasetRevisionResponse> = {
  ...
  create<I extends Exact<DeepPartial<GetDatasetRevisionResponse>, I>>(base?: I): GetDatasetRevisionResponse {
    return GetDatasetRevisionResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<GetDatasetRevisionResponse>, I>>(object: I): GetDatasetRevisionResponse {
    const message = createBaseGetDatasetRevisionResponse();
    message.revision = (object.revision !== undefined && object.revision !== null)
      ? DatasetRevisionMeta.fromPartial(object.revision)
      : undefined;
    return message;
  },
};
