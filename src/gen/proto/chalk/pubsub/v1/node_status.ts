...
export const NodeStatusPubSub: MessageFns<NodeStatusPubSub> = {
  ...
  create<I extends Exact<DeepPartial<NodeStatusPubSub>, I>>(base?: I): NodeStatusPubSub {
    return NodeStatusPubSub.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<NodeStatusPubSub>, I>>(object: I): NodeStatusPubSub {
    const message = createBaseNodeStatusPubSub();
    ...
    message.chalkManaged = object.chalkManaged ?? false;
    return message;
  },
};
...
export const NodeStatusPubSub_LabelsEntry: MessageFns<NodeStatusPubSub_LabelsEntry> = {
  ...
  create<I extends Exact<DeepPartial<NodeStatusPubSub_LabelsEntry>, I>>(base?: I): NodeStatusPubSub_LabelsEntry {
    return NodeStatusPubSub_LabelsEntry.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<NodeStatusPubSub_LabelsEntry>, I>>(object: I): NodeStatusPubSub_LabelsEntry {
    const message = createBaseNodeStatusPubSub_LabelsEntry();
...
export const NodeStatusPubSub_AnnotationsEntry: MessageFns<NodeStatusPubSub_AnnotationsEntry> = {
  ...
  create<I extends Exact<DeepPartial<NodeStatusPubSub_AnnotationsEntry>, I>>(
    base?: I,
  ): NodeStatusPubSub_AnnotationsEntry {
    return NodeStatusPubSub_AnnotationsEntry.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<NodeStatusPubSub_AnnotationsEntry>, I>>(
    object: I,
  ): NodeStatusPubSub_AnnotationsEntry {
    const message = createBaseNodeStatusPubSub_AnnotationsEntry();
    message.key = object.key ?? "";
