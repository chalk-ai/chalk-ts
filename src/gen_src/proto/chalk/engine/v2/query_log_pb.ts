...
// @generated from file chalk/engine/v2/query_log.proto (package chalk.engine.v2, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
import { QueryStatus } from "../../common/v1/query_status_pb";

/**
 * @generated from message chalk.engine.v2.VersionedQueryName
 */
export class VersionedQueryName extends Message<VersionedQueryName> {
  ...
  static readonly typeName = "chalk.engine.v2.VersionedQueryName";
...
/**
 * @generated from message chalk.engine.v2.QueryLogFilters
 */
export class QueryLogFilters extends Message<QueryLogFilters> {
  ...
  /**
   * @generated from field: repeated chalk.engine.v2.VersionedQueryName query_name = 3;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "chalk.engine.v2.QueryLogFilters";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message chalk.engine.v2.GetQueryLogEntriesPageToken
 */
export class GetQueryLogEntriesPageToken extends Message<GetQueryLogEntriesPageToken> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "chalk.engine.v2.GetQueryLogEntriesPageToken";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message chalk.engine.v2.GetQueryLogEntriesRequest
 */
export class GetQueryLogEntriesRequest extends Message<GetQueryLogEntriesRequest> {
   ...
   *
   * @generated from field: chalk.engine.v2.QueryLogFilters filters = 3;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "chalk.engine.v2.GetQueryLogEntriesRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message chalk.engine.v2.QueryLogEntry
 */
export class QueryLogEntry extends Message<QueryLogEntry> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "chalk.engine.v2.QueryLogEntry";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message chalk.engine.v2.GetQueryLogEntriesResponse
 */
export class GetQueryLogEntriesResponse extends Message<GetQueryLogEntriesResponse> {
  /**
   * @generated from field: repeated chalk.engine.v2.QueryLogEntry entries = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "chalk.engine.v2.GetQueryLogEntriesResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
